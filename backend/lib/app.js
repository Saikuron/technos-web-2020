...
app.get('/channels/:id/messages', async (req, res) => {
  const message = await db.messages.list(req.params.id) // Ajouter l'ID du channel en paramètre et retourner uniquement les messages de ce channel
  res.json(message)
})

app.post('/channels/:id/messages', async (req, res) => {
  const message = await db.messages.create(req.params.id, req.body) // Ajouter l'ID du channel en paramètre et retourner uniquement les messages de ce channel
